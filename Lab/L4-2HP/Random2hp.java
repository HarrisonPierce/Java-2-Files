...
/**
 * This program is the second level of the math game la4_hp which calculates the sum of
 * two random numbers between 10 and 20 and asks the user to enter the correct answer.
...
public class Random2hp
{
                ...
                public void randomgen()                             //This method generates random numbers between 10 and 20 and sets them equal to appropriate variables
                {
                    Random rand = new Random();                     //create random object
                    num1 = rand.nextInt(20 - 10 +1)+10;             //generate and set num1
                    num2 = rand.nextInt(20 - 10 +1)+10;             //generate and set num2
